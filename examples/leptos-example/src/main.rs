...
#[component]
fn view_component_button() -> impl IntoView {
    view! {
...
#[component]
fn view_component_text() -> impl IntoView {
    view! {
        <div class="component-demo">
            <h3>"Text"</h3>
...
#[component]
fn view_component_input() -> impl IntoView {
    view! {
        <div class="component-demo">
            <h3>"Input"</h3>
            <div class="tg-input-wrapper">
                <input type="text" class="tg-input" placeholder="Enter text..." />
            </div>
            <div class="tg-input-wrapper tg-input-wrapper-filled">
                <input type="text" class="tg-input" value="Pre-filled value" />
...
#[component]
fn view_component_checkbox() -> impl IntoView {
    view! {
        <div class="component-demo">
            <h3>"Checkbox"</h3>
...
#[component]
fn view_component_radio() -> impl IntoView {
    view! {
        <div class="component-demo">
            <h3>"Radio"</h3>
...
#[component]
fn view_component_select() -> impl IntoView {
    view! {
        <div class="component-demo">
            <h3>"Select"</h3>
...
#[component]
fn view_component_slider() -> impl IntoView {
    view! {
        <div class="component-demo">
            <h3>"Slider"</h3>
            <input type="range" class="tg-slider" min="0" max="100" value="50" />
            <input type="range" class="tg-slider tg-slider-disabled" min="0" max="100" value="75" disabled />
        </div
    }
}

#[component]
fn view_component_switch() -> impl IntoView {
    view! {
        <div class="component-demo">
            <h3>"Switch"</h3>
...
#[component]
fn view_component_avatar() -> impl IntoView {
    view! {
        <div class="component-demo">
            <h3>"Avatar"</h3>
...
#[component]
fn view_component_button_group() -> impl IntoView {
    view! {
        <div class="component-demo">
            <h3>"Button Group"</h3>
...
#[component]
fn view_component_card() -> impl IntoView {
    view! {
        <div class="component-demo">
            <h3>"Card"</h3>
            <div class="tg-card">
...
#[component]
fn view_component_list() -> impl IntoView {
    view! {
        <div class="component-demo">
            <h3>"List"</h3>
            <div class="tg-list">
...
#[component]
fn view_component_modal() -> impl IntoView {
    view! {
        <div class="component-demo">
            <h3>"Modal"</h3>
...
#[component]
fn view_component_popup() -> impl IntoView {
    view! {
        <div class="component-demo">
            <h3>"Popup"</h3>
...
#[component]
fn view_component_progress() -> impl IntoView {
    view! {
        <div class="component-demo">
            <h3>"Progress"</h3>
...
#[component]
fn view_component_search() -> impl IntoView {
    view! {
        <div class="component-demo">
            <h3>"Search"</h3>
            <div class="tg-search">
                <div class="tg-search-input-wrapper">
                    <input type="text" class="tg-search-input" placeholder="Search..." />
...
#[component]
fn view_component_tabs() -> impl IntoView {
    view! {
        <div class="component-demo">
            <h3>"Tabs"</h3>
            <div class="tg-tabs">
...
#[component]
fn view_component_toolstrip() -> impl IntoView {
    view! {
        <div class="component-demo">
            <h3>"Toolstrip"</h3>
...
#[component]
fn view_component_actions_sheet() -> impl IntoView {
    view! {
        <div class="component-demo">
            <h3>"Actions Sheet"</h3>
...
#[component]
fn view_component_alert() -> impl IntoView {
    view! {
        <div class="component-demo">
            <h3>"Alert"</h3>
...
#[component]
fn view_component_snackbar() -> impl IntoView {
    view! {
        <div class="component-demo">
            <h3>"Snackbar"</h3>
...
#[component]
fn view_component_loading() -> impl IntoView {
    view! {
        <div class="component-demo">
            <h3>"Loading"</h3>
